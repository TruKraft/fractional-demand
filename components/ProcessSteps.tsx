  ...
  return (
    <section className={`bg-black text-white ${className}`}>
      <div className="container mx-auto px-4 py-24 md:py-28">
        {headline && (
          <Reveal as="h2" className="text-center text-4xl md:text-5xl  tracking-tight mb-12">
            {headline}
          </Reveal>
        )}
            ...
            <Reveal key={idx} className="relative">
              <div className="flex gap-6 md:gap-8">
                <div className="shrink-0 relative">
                  <div className="w-16 h-16 rounded-full bg-white/10 border-2 border-white/20 flex items-center justify-center text-2xl  text-white ring-2 ring-white/10 relative z-10">
                    {step.number}
                  </div>
                  {idx < steps.length - 1 && (
