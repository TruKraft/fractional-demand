  ...
  return (
    <section id="why-us" className="bg-black text-white">
      <div className="container mx-auto px-4 py-24 md:py-28">
        <Reveal as="h2" className="text-center text-4xl md:text-5xl font-bold tracking-tight mb-8">When you'd need us…</Reveal>
        ...
        <div className="mt-10 grid gap-6 md:gap-8 md:grid-cols-3 max-w-5xl mx-auto">
          <Reveal className="relative text-left rounded-3xl p-8 overflow-visible">
            ...
            <div className="text-2xl md:text-3xl font-bold">Fill the gap</div>
          ...
          <Reveal className="relative text-left rounded-3xl p-8 overflow-visible" >
            ...
            <div className="text-2xl md:text-3xl font-bold">Early stage</div>
          ...
          <Reveal className="relative text-left rounded-3xl p-8 overflow-visible">
            ...
            <div className="text-2xl md:text-3xl font-bold">Revitalize</div>
