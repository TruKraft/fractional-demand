...
export default function PaidMediaHero() {
  ...
  const auditItems = [
    "Quick wins for cost reduction + conversion lift",
    "Platform structural analysis and fixes",
    "Conversion tracking fixes/improvements",
    "Hidden wasted spend from network + targeting leakage",
    "What is working right now for other tech companies",
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 pt-28 md:pt-36 pb-16 md:pb-24">
        <div className="grid gap-10 lg:gap-12 lg:grid-cols-[60%_40%] items-center">
          ...
          <div className="order-1 lg:order-1">
            ...
            <Reveal>
              <div>
                <h3 className="text-xl md:text-2xl font-semibold mb-5">What&apos;s Inside The Audit</h3>
          ...
          <div className="order-2 lg:order-2 lg:sticky lg:top-28 self-start">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 md:px-8 md:py-16 ">
              <h3 className="text-xl md:text-3xl font-semibold mb-6 text-center">Get Your Free Audit</h3>
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-white/70">We&apos;ll be in touch shortly with your audit.</p>
                </div>
              ) : (
